...
const isFormValid = computed(() => {
    if (!form.fullName) return errorObj("Fulll Name");
    else if (!form.email && !form.contact) return errorObj("Email or contact");
    else if (!form.message) return errorObj("Message");
    else return true;
})
